...
import 'package:travelnew_app/Api/model/aspired_trip_model.dart';
                                    ...
                                    Stack(
                                      children: [
                                        ClipRRect(
                                            ...
                                            child: Image.network(allData[i].image! ==""?NoTripNetworkImage:allData[i].image!)),
                                        Positioned(
                                          top: -5,
                                          right: -5,
                                          child: IconButton(
                                          ...
                                          Expanded(
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                addVerticalSpace(10),
                                                Text(
                                                  "Agent Id - "+allData[i].travelAgent!.toString(),
