...
import '../../Api/model/aspiredTrip_detail_model.dart' as detail_aspired;
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      addVerticalSpace(15),
                      FutureBuilder(
                          future: ApiHelper.get_aspired_trip_details_apiCall(id: 30),
                          builder: (context, snapshot) {
                            if(snapshot.hasData) {
                              detail_aspired.aspire_trip_detail_get_model data=snapshot.data!;
                              return  SizedBox(
                                          ...
                                          Row(children: [
                                            ClipRRect(
                                              ...
                                              child: Container(
                                                ...
                                                child: Image.network(
                                                  data.data![i].image! == "" ?NoTripNetworkImage:data.data![i].image!,
                                                  fit: BoxFit.fill,
                                                ),
                                              ),
                                            ),
