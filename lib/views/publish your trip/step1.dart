...
import '../../Api/model/get_trip_city_model.dart';
import '../../Api/model/prima_type_dropdwon_model.dart';
...
class _Step1State extends State<Step1> {
  ...
  // String selected_prima_type = "Select Type";
  // int selected_prima_type_id = -1;
  // String selected_prima_city= "-1";
  // int selected_prima_city_id = -1;
        ...
        Padding(
          ...
          child: SizedBox(
            ...
            child: Container(
              ...
              child: FutureBuilder(
                future: ApiHelper.get_prima_type_dropdown(),
                builder: (context, snapshot) {
                  if (snapshot.hasData) {
                    List<Data> categoryList = snapshot.data!.data ?? [];
                    ...
                    return Padding(
                      ...
                      child: DropdownButton<Data>(
                        ...
                        onChanged: (newValue) {
                          setState(() {
                            selectedCityOfPrimaTrip = newValue!.category!;
                         //   selected_prima_type_id = newValue.id ?? -1;
                          });
                        },
                        items: categoryList.map<DropdownMenuItem<Data>>((Data value) {
                          //    printc(value['prima']);
        ...
        Padding(
          ...
          child: SizedBox(
            ...
            child: Container(
              ...
              child: FutureBuilder(
                future: ApiHelper.get_tripCity_api_call(),
                builder: (context, snapshot) {
                  if (snapshot.hasData) {
                    List<Data3> categoryList = snapshot.data!.data ?? [];
                    //  print("--- ${snapshot.hasError}----" + '${snapshot.data!.data}');
                    return Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: DropdownButton<Data3>(
                        borderRadius: BorderRadius.circular(10),
                        // value: null,
                        ...
                        onChanged: (newValue) {
                          setState(() {
                            selectedTypeOfPrimaTrip = newValue!.city!;
                            //selected_prima_city_id = (newValue.cityId?? -1);
                          });
                        },
                        items: categoryList.map<DropdownMenuItem<Data3>>((Data3 value) {
                          //    printc(value['prima']);
                          return DropdownMenuItem<Data3>(
                            value: value,
                            child: Padding(
                              padding: const EdgeInsets.only(left: 5),
                              child: Text(
                ...
                children: [
                  SizedBox(
                      ...
                      child: CustomTextFieldWidget(
                        ...
                        onClick: () async {
                          var pickedDate = await showDatePicker(context: context, initialDate: DateTime.now(), firstDate: DateTime.now(), lastDate: DateTime(2101));
                  ...
                  SizedBox(
                      ...
                      child: CustomTextFieldWidget(
                        ...
                        onClick: () async {
                          if (firstDate != null) {
                            var pickedDate = await showDatePicker(context: context, initialDate: firstDate!, lastDate: DateTime(3000), firstDate: firstDate!);
                            if (pickedDate != null) {
                              print(pickedDate);
  ...
  void pickUploadImage() async {
    final image =
        await ImagePicker().pickImage(source: ImageSource.gallery, maxWidth: MediaQuery.of(context).size.width, maxHeight: MediaQuery.of(context).size.height, imageQuality: 75);
