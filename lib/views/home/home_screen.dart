...
import '../../Api/model/event_trip_get_model.dart' as event;
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> getQuickEscData1() async {
    CollectionReference _collectionRef11 =
        FirebaseFirestore.instance.collection('QuickEscapeTrip');
        ...
        children: [
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                //                   child: Image.asset(
                //                     allQuickData[index]['img'],
                //                     fit: BoxFit.fill,
                //                   ),
                //                 ),
                //               ),
                //               Text(
                //                 allQuickData[index]['name'],
                            ...
                            children: [
                              CircleAvatar(
                                ...
                                child: ClipRRect(
                                  borderRadius: BorderRadius.circular(60),
                                  child: Image.network(
                                    allQuickData[index]['imageUrl'],
                                    fit: BoxFit.fill,
                                  ),
                                ),
                              ),
                              Text(
                                allQuickData[index]['city'],
                                style: bodyText12Small(color: white),
                              )
                            ],
                          ),
          ...
          Padding(
            ...
            child: SizedBox(
              ...
              child: FutureBuilder(
                future: ApiHelper.get_event_trip_apiCall(month: 1),
                builder: (context, snapshot) {
                  if (snapshot.hasError) {
                    ...
                    List<event.Data> allHomeData = snapshot.data!.data!;
                    print('${snapshot.hasData}==================++++++++++++');
                    print('${allHomeData.length}=======event trip data length+++++++++');
                    return allHomeData.length==0?Center(child: Text("No data Available")):ListView.builder(
          ...
          //       InkWell(
          //         onTap: () {
          //           Navigator.push(context, MaterialPageRoute(builder: (ctx) => ProfileFeedScreen()));
          //         },
          //         child: Text(
          //           'View all >',
          //           style: bodyText14w600(color: black),
          ...
          addVerticalSpace(5),
          FutureBuilder(
              future: ApiHelper.get_aspired_trip_apiCall(),
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  return SliderWidget(
                    imageList: snapshot.data!.data!,
                  );
