class aspire_trip_detail_get_model {
  int? status;
  List<Data>? data;
  String? message;

  aspire_trip_detail_get_model({this.status, this.data, this.message});

  aspire_trip_detail_get_model.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
...
class Data {
  ...
  Data({this.dayId, this.tripId, this.day, this.image, this.touristSpot});
