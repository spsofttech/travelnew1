...
class FirebaseAuthen {
  static FirebaseAuthen fire=FirebaseAuthen();
  late final GoogleSignInAccount? googleSignInAccount;
  final _googleSignIn = GoogleSignIn();

  registerUser(String userid, String userMail, String photoUrl, String name) async {
  ...
  registerFBUser(String userid, String userMail, String photoUrl, String name, String dob, String gender) async {
    final _fireStore = FirebaseFirestore.instance;
  }
